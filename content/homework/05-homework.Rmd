...
You may be pleased to know that this week's homework does not require you to write a single line of code. Instead, it is designed to get you reading and interpreting data graphics. [OD Maps](https://xeno.graphics/od-map/) are a good candidate here as they have been catalogued by [Marteen Lambrechts](https://www.maartenlambrechts.com) as a Xenographic -- *Weird but (sometime) useful*. I'd add that within the list of other [Xenographics](https://xeno.graphics), OD Maps are *Not that weird and often useful*. Nevertheless, they do take some interpretation.
