...
The code block below points to the packages you need to do the work discussed in the session. Uncomment the `intall_packages()` lines if you have not already downloaded `stats19` and `trafficalmr`.
...
# And read in as`.fst`.
vehicles_all <- read_fst("/Users/roger/Downloads/vehicles_all.fst")
casualties_all <- read_fst("/Users/roger/Downloads/casualties_all.fst")
crashes_all <- read_fst("/Users/roger/Downloads/crashes_all.fst")
```
